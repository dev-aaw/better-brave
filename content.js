...
const i18nDict = {
  ...
  de: {
    ...
    transTitle: "🇩🇪 Deutsche Übersetzung",
    openGoogleTrans: "Google Übersetzer ↗",
    highlightYellow: "Gelb markieren",
    highlightBlue: "Blau markieren",
    highlightGreen: "Grün markieren",
    removeHighlight: "Markierung entfernen",
    addNote: "Notiz hinzufügen",
    exportNotes: "Notizen exportieren (.md)",
  ...
  es: {
    ...
    transTitle: "🇪🇸 Traducción al Español",
    openGoogleTrans: "Google Traductor ↗",
    highlightYellow: "Resaltar Amarillo",
    highlightBlue: "Resaltar Azul",
    highlightGreen: "Resaltar Verde",
    removeHighlight: "Eliminar Resaltado",
    addNote: "Añadir Nota",
    exportNotes: "Exportar Notas (.md)",
  ...
  fr: {
    ...
    transTitle: "🇫🇷 Traduction en Français",
    openGoogleTrans: "Google Traduction ↗",
    highlightYellow: "Surligner en Jaune",
    highlightBlue: "Surligner en Bleu",
    highlightGreen: "Surligner en Vert",
    removeHighlight: "Supprimer le Surlignage",
    addNote: "Ajouter une Note",
    exportNotes: "Exporter les Notes (.md)",
